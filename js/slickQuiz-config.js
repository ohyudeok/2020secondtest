...
var quizJSON = {
    "info": {
        "name":    "신조어 영역",
        "main":    "<p style='text-align:center;'>신조어 모의고사를 통해 신조어에 대해 얼마나 알고 있는지 확인해보세요!</p>",
        "results": "<h5>신조어 모의고사 완료!</h5><p>문제 풀이 하느라 고생하셨습니다.</p>",
        "level1":  "당신은 신조어계 석유군요!",
        "level2":  "당신은 신조어계 썩은물입니다. 석유가 되기 위해 노력하세요!",
        "level3":  "신조어계에 고인물정도 되십니다.",
        "level4":  "신조어계 청정수와 고인물 사이 레벨에 있네요.",
        "level5":  "이런! 당신은 신조어계 청정수에요!" 
    },
    "questions": [
        { // Question 1
        ...
        { // Question 2
            ...
            "incorrect": "<p><span>틀렸어요! 정답은 ④번 찐친이다!</span> ① - ②: 팩트로 뼈를 맞아서 순살이 되었다는 의미. 순살치킨은 2천원 비싸기 때문에 한 번 더 꼬아서 이야기 하는 말. <br>③: 미희의 고민에 경아는 팩트로 대답했기 때문에 미희의 입장에선 팩트로 폭력을 당했다고 느낍니다.</p>" 
        },
        { // Question 3
        ...
        { // Question 10
            ...
            "incorrect": "<p><span>틀렸어요. 정답은 ④번 '0-X-X'입니다. 셀프바는 손님이 반찬을 덜어가는 곳으로, 혼자와는 상관이 없습니다.</span>(1) <strong>알부자:</strong> 원래 실속 있는 부자라는 뜻으로 쓰였지만, 최근에는 여러 알바를 병행하며 부족한 학자금을 충당하는 학생들에 대한 반어적 표현으로 쓰인다.<br>(2) <strong>애빼시:</strong> ‘애교 빼면 시체’라는 뜻을 가지고 있고, 육아 커뮤니티에서 사용되는 말이 아니다.<br>(3) <strong>힘숨찐:</strong> ‘힘을 숨긴 찐따’라는 뜻을 가지고 있다.</p>" 
        } // no comma here
